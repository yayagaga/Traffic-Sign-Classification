...
Ypred_svm = clf_svm.predict(newX[len(trainLabels)+1:])
print('original class: ',Y[len(trainLabels)+1:])
print('predicted class: ',Ypred_svm)
test_score_svm = accuracy_score(Y[len(trainLabels)+1:], Ypred_svm)
print("Test set score of svm: %0.6f" % test_score_svm)
